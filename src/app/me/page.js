        ...
        <main className="min-h-[calc(100vh-64px)] bg-[#f6f9ff] px-4 py-6 sm:px-6 sm:py-8 lg:py-10">
            <div className="mx-auto w-full max-w-6xl">
                <button
                    ...
                    aria-label="Go back"
                    className="mb-4 flex w-fit items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-blue-700 shadow-sm transition hover:bg-blue-50 sm:hidden"
                >
                    <ArrowLeft size={17} />
                    Back
                </button>
                ...
                <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_12px_35px_rgba(15,23,42,0.06)] lg:grid lg:grid-cols-[290px_1fr]">
                    <aside className="relative overflow-hidden bg-gradient-to-br from-[#071a4a] to-[#125fd8] p-5 text-white sm:p-6 lg:min-h-[500px] lg:p-7">
                        <div className="absolute -right-16 -top-16 h-44 w-44 rounded-full bg-white/[0.07]" />
                        <div className="absolute -bottom-24 -left-20 h-56 w-56 rounded-full bg-blue-300/[0.08]" />
                    ...
                    <div className="p-5 sm:p-7 lg:p-8">
                        ...
                        {isEditing ? (
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="h-11 w-full rounded-lg border border-slate-300 bg-white px-3.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                                        />
                                    </div>
                            ...
                            <div className="mt-5 grid gap-3.5 sm:grid-cols-2 sm:gap-4">
                                ...
                                <div className="flex min-h-24 items-center justify-between gap-4 rounded-xl border border-slate-200 bg-slate-50/70 p-4 transition hover:border-blue-200 hover:bg-blue-50/40 sm:col-span-2">
                                    ...
                                    <Link
                                        href="/me/password"
                                        className="flex h-9 shrink-0 items-center justify-center gap-1.5 rounded-lg border border-blue-200 bg-white px-3 text-[11px] font-semibold text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 focus:outline-none focus:ring-4 focus:ring-blue-100"
                                    >
                                        <Pencil size={14} />
                                        Update
                                    </Link>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mb-0 mt-1 text-[10px] leading-4 text-slate-500">
                                        Your account permissions and access are based on the role
                                        assigned through your profile.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-5 flex justify-end border-t border-slate-200 pt-5">
                            <button
                                ...
                                className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-5 text-sm font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-100 active:scale-[0.99] sm:w-auto"
                            >
