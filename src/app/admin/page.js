...
const Admin = () => {
    ...
    return (
        <main className="min-h-screen bg-[#f5f7fb]">
            <header className="sticky top-0 z-50 flex h-16 w-full items-center justify-between gap-2 border-b border-white/10 bg-[#102a63] px-2 text-white shadow-sm sm:h-[72px] sm:px-6">
                ...
                <div className="group relative flex max-w-[48%] justify-end">
                    ...
                    >
                        ...
                        <ChevronDown
                            size={15}
                            className={`hidden shrink-0 text-white transition-transform duration-200 sm:block ${showUserMenu ? "rotate-180" : ""
                    ...
                    <div
                        role="menu"
                        className={`absolute right-0 top-full z-[60] w-52 origin-top-right pt-2 transition-all duration-200 sm:w-56 ${showUserMenu
            ...
            <div className="flex min-h-[calc(100vh-64px)] min-w-[1180px] sm:min-h-[calc(100vh-72px)]">
                <aside className="sticky top-16 flex h-[calc(100vh-64px)] w-72 shrink-0 flex-col bg-[#102a63] text-white sm:top-[72px] sm:h-[calc(100vh-72px)]">
                ...
                <div className="min-w-0 flex-1">
                    <div className="mx-auto max-w-[1600px] p-8">
                        <section className="rounded-2xl border border-slate-200 bg-white px-7 py-6 shadow-sm">
                            ...
                            <h1 className="mt-1 text-xl font-bold tracking-tight text-blue-900">
